...
| T05 |  | expert_service_ops×3 | P1×3 | review×2, auto×1 | **no** |
| T06 |  | account_access×3 | P1×3 | auto×2, review×1 | **no** |
...
| T14 | noise | unclear_other×2, technical_bug×1 | P2×3 | review×3 | **no** |
| T15 | polite_but_urgent | refund_request×2, billing_subscription×1 | P1×3 | review×3 | **no** |

- tickets identical across all 3 runs: **11/15**
- category accuracy per run: 100%, 87%, 100%
